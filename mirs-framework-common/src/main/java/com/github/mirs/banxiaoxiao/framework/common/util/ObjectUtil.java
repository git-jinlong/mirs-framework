...
public class ObjectUtil {
    ...
    public static void mapToObject(Map<String, Object> map, Object obj) {
        ...
        for (String fieldName : map.keySet()) {
            ...
            try {
                ReflectionUtils.setFieldForMethod(obj.getClass(), fieldName, obj, val, val.getClass());
            } catch (Throwable e) {
            }
        }
    }
    ...
    public static Map<String, Object> objectToMap(Object obj) {
        ...
        for (Field field : declaredFields) {
            try {
                ...
                Method getMethod = ReflectionUtils.getMethod(obj.getClass(), methodName);
                if (getMethod == null) {
                    continue;
                } else {
                    Object val = ReflectionUtils.invokeMethod(getMethod, obj);
