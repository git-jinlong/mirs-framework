...
public class ShellProperties {
     ...
     */
    private String[] commandPathPatterns = new String[] { "classpath*:/commands/**", "file:configs/commands/**" };

    /**
     * Patterns to use to look for configurations.
     */
    private String[] configPathPatterns = new String[] { "classpath*:/commands/*","file:configs/commands/*" };
    ...
    /**
     * Comma-separated list of plugins to disable. Certain plugins are disabled by default based on the environment.
     */
    private String[] disabledPlugins = new String[]{"org.crsh.cron.CronPlugin"};
    ...
    public static class Auth {
        ...
        /**
         * Authentication type. Auto-detected according to the environment (i.e. if Spring Security is available, "spring" is used by default).
         */
    ...
    public static class SimpleAuthenticationProperties extends CrshShellAuthenticationProperties {
        ...
        protected void applyToCrshShellConfig(Properties config) {
            ...
            if (this.user.isDefaultPassword()) {
                logger.info(String.format("%n%nUsing default password for shell access: %s%n%n", this.user.getPassword()));
            }
        }
