 ...
 */
public class CDServiceBeanFactory extends AbstractConfig implements BeanDefinitionRegistryPostProcessor, EnvironmentAware, ResourceLoaderAware,
    ...
    public CDServiceBeanFactory(String... packagesToScan) {
        this(Arrays.asList(packagesToScan));
    }

    public CDServiceBeanFactory(Collection<String> packagesToScan) {
        this(new LinkedHashSet<String>(packagesToScan));
    }

    public CDServiceBeanFactory(Set<String> packagesToScan) {
    ...
    protected void addIncludeFilter(ClassPathBeanDefinitionScanner scanner) {
        scanner.addIncludeFilter(new AnnotationTypeFilter(CDS.class));
    }
    ...
    protected void registerServiceBean(BeanDefinitionHolder beanDefinitionHolder, BeanDefinitionRegistry registry,
        ...
        CDS service = findAnnotation(beanClass, CDS.class);
    ...
    private String generateServiceBeanName(Class<?> interfaceClass, String annotatedServiceBeanName) {
        StringBuilder beanNameBuilder = new StringBuilder(CDServiceBean.class.getSimpleName());
    ...
    private Class<?> resolveServiceInterfaceClass(Class<?> annotatedServiceBeanClass, CDS service) {
    ...
    private AbstractBeanDefinition buildServiceBeanDefinition(CDS service, Class<?> interfaceClass, String annotatedServiceBeanName) {
        BeanDefinitionBuilder builder = rootBeanDefinition(CDServiceBean.class);
