 ...
 * @since 2.5.7
 */
public class CDSReferenceBeanFactory extends InstantiationAwareBeanPostProcessorAdapter implements MergedBeanDefinitionPostProcessor, PriorityOrdered,
        ApplicationContextAware, BeanClassLoaderAware, DisposableBean {

    /**
     * The bean name of {@link CDSReferenceBeanFactory}
     */
    public static final String BEAN_NAME = "cDSReferenceBeanFactory";
    ...
    private List<ReferenceFieldElement> findFieldReferenceMetadata(final Class<?> beanClass) {
        ...
        ReflectionUtils.doWithFields(beanClass, new ReflectionUtils.FieldCallback() {
            ...
            public void doWith(Field field) throws IllegalArgumentException, IllegalAccessException {
                CDS cdsreference = getAnnotation(field, CDS.class);
                if (cdsreference != null) {
                    ...
                    elements.add(new ReferenceFieldElement(field, cdsreference));
                }
            }
        });
        return elements;
    ...
    private List<ReferenceMethodElement> findMethodReferenceMetadata(final Class<?> beanClass) {
        ...
        ReflectionUtils.doWithMethods(beanClass, new ReflectionUtils.MethodCallback() {
            ...
            public void doWith(Method method) throws IllegalArgumentException, IllegalAccessException {
                ...
                CDS cdsreference = findAnnotation(bridgedMethod, CDS.class);
                if (cdsreference != null && method.equals(ClassUtils.getMostSpecificMethod(method, beanClass))) {
                    ...
                    elements.add(new ReferenceMethodElement(method, pd, cdsreference));
                }
            }
        });
        return elements;
    ...
    private class ReferenceMethodElement extends InjectionMetadata.InjectedElement {
        ...
        private final CDS cdsreference;

        private volatile DReferenceBean<?> referenceBean;

        protected ReferenceMethodElement(Method method, PropertyDescriptor pd, CDS cdsreference) {
            super(method, pd);
            this.method = method;
        ...
        protected void inject(Object bean, String beanName, PropertyValues pvs) throws Throwable {
            ...
            if(null!=cdsreference){
                referenceBean = buildReferenceBean(cdsreference, referenceClass);
            }
    ...
    private class ReferenceFieldElement extends InjectionMetadata.InjectedElement {
        ...
        protected ReferenceFieldElement(Field field, CDS cdsreference) {
            super(field, null);
            this.field = field;
            this.cdsreference = cdsreference;
        }
    ...
    private DReferenceBean<?> buildReferenceBean(CDS reference, Class<?> referenceClass) throws Exception {
    ...
    private String generateReferenceBeanCacheKey(CDS reference, Class<?> beanClass) {
        String interfaceName = resolveInterfaceName(reference, beanClass);
        String key = "/" + interfaceName + "/cds";
        Environment environment = applicationContext.getEnvironment();
        key = environment.resolvePlaceholders(key);
        return key;
    }

    private static String resolveInterfaceName(CDS reference, Class<?> beanClass) throws IllegalStateException {
