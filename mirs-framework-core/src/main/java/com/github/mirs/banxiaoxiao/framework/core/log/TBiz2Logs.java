...
public class TBiz2Logs {
    ...
    private static TBizLogger2 getLocationAwareLogger(final int depth) {
        String className = sun.reflect.Reflection.getCallerClass(depth).getName();
        return FlowLoggers.getLogger(className).tbizLogger2();
    }
     ...
     * @return
     */
    private static TBizLogger2 getLogger() {
