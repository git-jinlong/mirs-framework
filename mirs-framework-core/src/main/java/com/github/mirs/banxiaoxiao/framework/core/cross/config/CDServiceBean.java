 ...
 */
public class CDServiceBean<T> extends CDServiceConfig<T> implements InitializingBean, DisposableBean, ApplicationContextAware,
    ...
    public void onApplicationEvent(ContextRefreshedEvent event) {
        if (isDelay() && !getConfig().isExported() && !getConfig().isUnexported()) {
            ...
            export();
            CrossFilterMapCacheHelper.clear();
        }
    }
