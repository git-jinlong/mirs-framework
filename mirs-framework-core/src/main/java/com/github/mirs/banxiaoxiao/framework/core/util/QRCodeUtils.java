...
public class QRCodeUtils {
    ...
    private static void insertImage(BufferedImage source, String imgPath,
        ...
        if (!file.exists()) {
            TComLogs.info(""+imgPath+"   imgPath not exists");
            return;
        }
    ...
    public static String encode(String content, String imgPath, String destPath,
        ...
        if (destPath.endsWith("/")){
            file = destPath+new Random().nextInt(99999999)+".jpg";
        }else {
            file = destPath + "/" +new Random().nextInt(99999999)+".jpg";
        }
     ...
     * @throws Exception
     */
    public static String encode(String content, String imgPath, String destPath,String fileName) throws Exception {
        BufferedImage image = QRCodeUtils.createImage(content, imgPath, true);
        mkdirs(destPath);
        String file;
        if (destPath.endsWith("/")){
            file = destPath+fileName.trim()+".jpg";
        }else {
            file = destPath + "/" +fileName.trim()+".jpg";
        }
...
/*    public static void main(String[] args) throws Exception {
        ...
        String logoPath = "C:\\Users\\ldf.ARCVIDEO\\Desktop\\TIM截图202006221451562.png";
        String destPath = "C:\\Users\\ldf.ARCVIDEO\\Desktop\\";
