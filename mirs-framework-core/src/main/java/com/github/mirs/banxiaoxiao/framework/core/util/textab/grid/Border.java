 ...
 */
package com.github.mirs.banxiaoxiao.framework.core.util.textab.grid;
...
public final class Border
{
    ...
    public static Border of(Chars chars) { return new Border(chars); }

    public Border(Chars chars) { this.chars = chars; }
